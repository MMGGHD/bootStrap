...
insert into user_tb(username, password, email, pic_url) values('cos', '1234', 'cos@nate.com', 'Basic2.jpg');
...
insert into reply_tb(comment, board_id, user_id) values('댓글3', 2, 1);
insert into reply_tb(comment, board_id, user_id) values('댓글4', 2, 2);
